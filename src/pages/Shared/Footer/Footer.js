    ...
    <div className="mt-16">
      ...
      <footer className="footer p-10  text-base-content">
        ...
        <div>
          ...
          <Link to={"/dashboard/addReview"} className="link link-hover">
            Add a review
          </Link>
          <Link to={"/dashboard/myOrders"} className="link link-hover">
            My Orders
          </Link>
        </div>
        <div>
      ...
      <footer className="footer px-10 py-4 border-t  bg-neutral text-white">
